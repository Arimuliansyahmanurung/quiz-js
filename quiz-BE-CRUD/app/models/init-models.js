...
const sequelize = new Sequelize(conn.DB, conn.USER, conn.PASSWORD, {
  host: "localhost",
  dialect: "postgres",
...
const initModels = (sequelize) => {
  ...
  job_history.belongsTo(departements, {
    as: "departement",
    foreignKey: "departement_id",
  });
  departements.hasMany(job_history, {
    as: "job_histories",
    foreignKey: "departement_id",
  });
  departements.belongsTo(employees, {
    as: "manager",
    foreignKey: "manager_id",
  });
  employees.hasMany(departements, {
    as: "departements",
    foreignKey: "manager_id",
  });
  ...
  departements.belongsTo(locations, {
    as: "location",
    foreignKey: "location_id",
  });
  locations.hasMany(departements, {
    as: "departements",
    foreignKey: "location_id",
  });
